...
# Derived from the Laminar package's scanner. Placeholders: DBGATE, io.github.orcvole.dbgate.
#
# secret-scan.sh: the pre-publish secret and anonymity release gate for io.github.orcvole.dbgate.
#
